...
class TwoEchelonEnv:
    """
    Two-Echelon Linear Inventory Environment for Experiment A1.
    ...
    def __init__(
        ...
        *,
        lead_time_W: int   = 3,    # supplier → warehouse lead time
        ...
        max_W, step_W = compute_adaptive_params(demand_series, n_actions_W, lead_time_W)
    ...
    def reset(self):
        ...
        # Order pipelines
        self.pipeline_W = deque([0] * self.L_W, maxlen=self.L_W)  # to warehouse
    ...
    def step(self, action_index: int):
        ...
        incoming_W = self.pipeline_W.popleft()
    ...
    def _get_state(self) -> np.ndarray:
        ...
        norm_pipeline_W = np.clip(
            sum(self.pipeline_W) / max(self.max_order_W, 1), 0, 2)
