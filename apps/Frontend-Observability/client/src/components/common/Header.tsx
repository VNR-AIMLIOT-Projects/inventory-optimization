  ...
  return (
    <header className="h-16 flex items-center justify-between px-6 mb-2 glass rounded-3xl mx-4 mt-4 shrink-0 shadow-lg shadow-background/5">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="rounded-xl border border-border/50 bg-background/50 flex items-center gap-2 pl-2 pr-3 h-9 transition-colors">
          <div className="w-6 h-6 rounded-md bg-primary/10 text-primary border border-primary/30 flex items-center justify-center text-xs font-bold transition-colors">
            {usernameInitial}
          </div>
